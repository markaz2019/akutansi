...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Laporan Hitungan Nirwana</h1>
  ...
  <div class="card shadow mb-4">
    ...
    <br>
    <form action="/cari_nirwana" method="POST">
      @csrf
      <div class="row">
        <div class="col-3"></div>
        <div class="col-6">
...
=======
        <div class="col-1"></div>
        <div class="col-1">
          <a href="/hitung_nirwana/export_excel" class="btn btn-primary">Export Excel</a>
        </div>
        <div class="col-1">
