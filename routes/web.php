...
Route::get('/cari_laporan', 'LaporanController@cari');
Route::post('/cari_laporan', 'LaporanController@cari');
//Route::post('/cari', 'KiselBaruController@cari');
Route::get('/kisel_selisih', 'KiselSelisihController@index');
Route::post('/cari_kisel_selisih', 'KiselSelisihController@cari');
Route::get('/mlink', 'MlinkController@index');
Route::post('/cari_mlink', 'MlinkController@cari');
